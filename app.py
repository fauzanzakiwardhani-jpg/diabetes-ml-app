...
if menu == "Prediction":
    ...
    if submit:
        ...
        st.success("✅ Tidak Diabetes" if prediction[0] == 0 else "⚠️ Berpotensi Diabetes")
...
st.header("4️⃣ Machine Learning Modeling")
...
st.markdown("""
### Recommendation
✅ Random Forest direkomendasikan karena memiliki performa akurasi yang lebih tinggi dan stabil.
""")

# Cell 7: Prediction Form

st.header("5️⃣ Coba Prediksi Diabetes")
...
if submit:
    ...
    if result[0] == 1:
        st.error("⚠️ TERDETEKSI DIABETES")
    else:
